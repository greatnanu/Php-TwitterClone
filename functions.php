...
function displayTweets($type) {
  ...
  if (mysqli_num_rows($result) == 0) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo "<div class ='box'><p ><a href='?page=publicprofiles&userid=".$user['id']."'>".$user['email']."</a> <span class='time'>".formatDate($row['datetime'])."</span></p>";
          
          echo "<p>".$row['tweet']."</p>";
          
          echo "<p><a class='btn toggleFollow' data-userId='".$row['userid']."'>";
